game.setDialogFrame(img`
    ...
    ..66666666666666666666..
    `)
game.showLongText("Welcome to Mr P's Quiz", DialogLayout.Full)
game.showLongText("In this game you will answer as many correct answers as you can!", DialogLayout.Full)
pause(1000)
...
let Teacher = sprites.create(img`
    ...
    . . . f f . . f f . . . 
    `, SpriteKind.Player)
Teacher.changeScale(0.8, ScaleAnchor.Middle)
Teacher.setPosition(53, 90)
pause(1000)
Teacher.sayText("Hello everybody!", 3000, false)
pause(2000)
Teacher.sayText("How are you going today?", 3000, false)
pause(2000)
Teacher.sayText("Let's call our first volunteer!", 3000, false)
pause(2000)
...
let Student = sprites.create(img`
    ...
    . . . . f f . . f f . . . . 
    `, SpriteKind.Player)
Student.setPosition(107, 96)
Student.changeScale(0.5, ScaleAnchor.Middle)
pause(2000)
Teacher.sayText("What's your name young lady?", 3000, false)
pause(2000)
let studentName = game.askForString("", 12)
pause(2000)
Teacher.sayText("Welcome " + studentName + " and good luck!", 3000, true)
pause(500)
Teacher.sayText("Let's start it!", 3000, true)
pause(2000)
Teacher.sayText("Question 1:", 3000, true)
pause(2000)
info.setScore(0)
let q1 = game.askForNumber("What is 2+2?")
if (q1 == 4) {
    Teacher.sayText("Well done!", 3000, true)
    info.changeScoreBy(1)
    Student.sayText(":)")
} else {
    Teacher.sayText("That's wrong!", 3000, true)
    Student.sayText(":(")
}
